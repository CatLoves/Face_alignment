...
% Modified by Fedor Ng
% inparms = glmnetControl();
% if ~exist('inparms') || isempty(inparms)
%     tic;
%     load('E:/face_alignment/Matlab/Tools/glmnet/ivals.mat','ivals')
%     inparms = ivals;
%     toc;
% end

% Just set the value. Written by Fedor Ng on 2017-11-22
inparms.fdev = 1e-5;
inparms.devmax = 0.999;
inparms.eps = 1e-6;
inparms.big = 9.9e35;
inparms.mnlam = 5;
inparms.pmin = 1e-5;
